...
processed_csv=./adp-analyzed.csv
...
adp_processed_lines=$(wc -l < $processed_csv | tr -d ' ')

echo "$formatted_start_date,$nvd_awaiting_lines,$nvd_analyzed_lines,$nvd_modified_lines,$nvd_rejected_lines,$nvd_other_lines,$adp_processed_lines" >> daily-stats.csv
